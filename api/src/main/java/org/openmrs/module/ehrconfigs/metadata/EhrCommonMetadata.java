...
public class EhrCommonMetadata extends AbstractMetadataBundle {
	...
	public void install() throws Exception {
		...
		install(role("MCH Clinic user for ANC", "ANC queue", (idSet("API Privileges (View and Edit)")),null));
		install(role("MCH Clinic user for PNC", "PNC queue", (idSet("API Privileges (View and Edit)")), null));
		install(role("MCH Clinic user for FP", "FP queue", (idSet("API Privileges (View and Edit)")), null));
		install(role("MCH Clinic user for CWC", "CWC queue", (idSet("API Privileges (View and Edit)")), null));
		install(role("CWC Immunization Queue", "Immunization", (idSet("API Privileges (View and Edit),")), null));
