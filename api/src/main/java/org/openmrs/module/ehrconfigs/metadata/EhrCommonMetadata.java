...
public class EhrCommonMetadata extends AbstractMetadataBundle {
	...
	public static final class _Privileges{
        ...
        public static final String ONCOLOGY = "App: Access Oncology";
    }
    ...
    public static final class _Roles{
	    ...
	    public static final String ONCOLOGYAPP = "Access Oncology";
    }
	...
	public void install() throws Exception {
        ...
        install(privilege(_Privileges.ONCOLOGY,"Access Oncology App"));
		...
		install(role(_Roles.ONCOLOGYAPP,"Access Oncology App", idSet(SecurityMetadata._Role.API_PRIVILEGES_VIEW_AND_EDIT),
                idSet(_Privileges.ONCOLOGY)));
