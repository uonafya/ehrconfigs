...
public class EhrCommonMetadata extends AbstractMetadataBundle {
	...
	public static final class _EhrIdenifiers {
		...
		public static final String IPD_NUMBER = "CCBED3FA-B334-412C-BD4E-9B823C8DB0EF";
	}

	public static final class _Privileges{

		public static final String MCH_CLINIC = "Access MCH Clinic";
		public static final String EHR_FINANCE_REPORT_SECTION = "Access Finance Report Section";
		...
		public static final String PAC_APP = "App: patientqueueapp.pac";
		...
		public static final String EHR_CONFIGS = "App: ehrconfigs.home";

	}

	public static final class _Roles{

		public static final String MCH_ANC ="MCH Clinic user for ANC";
		public static final String MCH_PNC ="MCH Clinic user for PNC";
		public static final String MCH_FP ="MCH Clinic user for FP";
		public static final String MCH_CWC ="MCH Clinic user for CWC";
		public static final String MCH_IMMUNIZATION ="CWC Immunization Queue";

		public static final String MATERNITY_APP = "Access Maternity Triage";
		public static final String DELIVERY_APP = "Access Delivery";
	...
	public void install() throws Exception {
		...
		install(patientIdentifierType("Birth Certificate Number BCN",
				"Assigned to every person at birth, it is unique in Kenyan setting", ".{1,15}", "At most 15 characters long",
				null, PatientIdentifierType.LocationBehavior.NOT_USED, false, _EhrIdenifiers.BIRTH_CERTIFICATE_NUMBER_BCN));
		...
		install(patientIdentifierType("IPD Number",
				"Assigned to every patient who goes through the IPD", ".{1,30}", "At most 30 characters long",
				null, PatientIdentifierType.LocationBehavior.NOT_USED, false, _EhrIdenifiers.IPD_NUMBER));
		//global property
		...
		install(privilege(_Privileges.DELIVERY_APP,"Access Delivry APP"));
		...
		install(privilege(_Privileges.EHR_CONFIGS,"Access EHR Configs application"));
		install(privilege(_Privileges.EHR_FINANCE_REPORT_SECTION,"Access Finance Report Section"));
		...
		install(role(_Roles.MCH_ANC, "ANC queue", (idSet("API Privileges (View and Edit)")),null));
		install(role(_Roles.MCH_PNC, "PNC queue", (idSet("API Privileges (View and Edit)")), null));
		install(role(_Roles.MCH_FP, "FP queue", (idSet("API Privileges (View and Edit)")), null));
		install(role(_Roles.MCH_CWC, "CWC queue", (idSet("API Privileges (View and Edit)")), null));
		install(role(_Roles.MCH_IMMUNIZATION, "Immunization", (idSet("API Privileges (View and Edit)")), null));
		install(role(_Roles.MATERNITY_APP,"Access Maternity Triage",idSet(SecurityMetadata._Role.API_PRIVILEGES_VIEW_AND_EDIT),
				idSet(_Privileges.MATERNITY_TRIAGE_APP)));
		install(role(_Roles.DELIVERY_APP,"Access Delivery App",idSet(SecurityMetadata._Role.API_PRIVILEGES_VIEW_AND_EDIT),
				idSet(_Privileges.DELIVERY_APP)));
		install(role(_Roles.PAC_APP,"Access PAC Room",idSet(SecurityMetadata._Role.API_PRIVILEGES_VIEW_AND_EDIT),
				idSet(_Privileges.PAC_APP)));
		install(role(_Roles.EHR_NCD,"Access NCD application",idSet(SecurityMetadata._Role.API_PRIVILEGES_VIEW_AND_EDIT),
		...
		install(role(_Roles.EHR_CONFIGS,"Access EHR Configs application",idSet(SecurityMetadata._Role.API_PRIVILEGES_VIEW_AND_EDIT),
				idSet(_Privileges.EHR_CONFIGS)));
		install(role(_Roles.EHR_ACCESS_FINANCE_REPORT_SECTION,"Access Finance Report Section",idSet(SecurityMetadata._Role.API_PRIVILEGES_VIEW_AND_EDIT),
				idSet(_Privileges.EHR_FINANCE_REPORT_SECTION)));
		...
		install(patientIdentifierType("OpenMRS ID", "Medical Record Number generated by OpenMRS for every patient",
				null, null, null,
				PatientIdentifierType.LocationBehavior.REQUIRED, true, CommonMetadata._PatientIdentifierType.OPENMRS_ID));
